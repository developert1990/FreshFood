export const INVALID_EMAIL_MESSAGE = "Oh no, Please enter a valid email address.";
export const INVALID_ZIPCODE_MESSAGE = "Oh no, Please enter a valid zip code."
export const GET_ALL_ITEMS_FAIL_MESSAGE = "Cannot get food list";
